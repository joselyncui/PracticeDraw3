...
public class Practice14GetFontMetricsView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawText(texts[0], 100, middle-(fm.ascent+fm.descent)/2, paint2);
        canvas.drawText(texts[1], 200, middle-(fm.ascent+fm.descent)/2, paint2);
        canvas.drawText(texts[2], 300, middle-(fm.ascent+fm.descent)/2, paint2);
        canvas.drawText(texts[3], 400, middle-(fm.ascent+fm.descent)/2, paint2);
        canvas.drawText(texts[4], 500, middle-(fm.ascent+fm.descent)/2, paint2);
        canvas.drawText(texts[5], 600, middle-(fm.ascent+fm.descent)/2, paint2);
    }
}
