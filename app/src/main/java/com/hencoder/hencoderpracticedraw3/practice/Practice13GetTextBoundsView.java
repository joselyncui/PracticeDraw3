...
//        canvas.drawRect(rect,paint1);
        ...
        canvas.drawText(text2, 200, middle- (rect.top + rect.bottom) / 2, paint2);
        canvas.drawRect(rect,paint2);

        paint2.getTextBounds(text3,0,text3.length(),rect);
        canvas.drawText(text3, 300, middle- (rect.top + rect.bottom) / 2, paint2);

        paint2.getTextBounds(text4,0,text4.length(),rect);
        canvas.drawText(text4, 400, middle- (rect.top + rect.bottom) / 2, paint2);

        paint2.getTextBounds(text5,0,text5.length(),rect);
        canvas.drawText(text5, 500, middle- (rect.top + rect.bottom) / 2, paint2);
        paint2.getTextBounds(text6,0,text6.length(),rect);
        canvas.drawText(text6, 600, middle- (rect.top + rect.bottom) / 2, paint2);
    }
}